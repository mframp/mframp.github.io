// Special thanks to this guy and all his great explanations: http://blog.sklambert.com/html5-game-tutorial-module-pattern/
...
$(function () {
  ...
  var assetLoader = (function() {
    ...
    this.imgs        = {
      ...
      'avatar_normal' : 'imgs/move0.png',
      'water'         : 'imgs/shapes_blank.svg'
  ...
  var player = (function(player) {
    ...
    // spritesheets
    player.sheet     = new SpriteSheet('imgs/move0.png', player.width, player.height);
    ...
    player.draw = function() {
      player.anim.draw(player.x, player.y-3);
    };
